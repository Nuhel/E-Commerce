            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme"> 
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#x"><img alt="" src="{{asset('front/images/cat-slider-img1.jpg')}}"></a>
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#x"><img alt="" src="{{asset('front/images/cat-slider-img2.jpg')}}"></a> </div>
                    ...
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                          <figure> <img class="first-img" src="{{asset('/items/' . $product->imagePath)}}" alt=""> <img class="hover-img" src="{{asset('/items/' . $product->imagePath)}}" alt=""></figure>
                          </a>
