                    ...
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="{{ $productshop->title }}" href="{{url('shop-details/'.$productshop->id.'/'.$productshop->subcategory_id)}}">
                          ...
                          <a type="button" href="{{ route('product.addToCart', ['id' => $productshop->id]) }}" class="add-to-cart-mt" data-id="{{ $productshop->id }}">add to cart</a>
                        </div>
                          ...
                          <div class="item-content">
                            ...
                            <div class="item-price">
                              <div class="price-box">
                                ...
                                <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"> ${{ $productshop->price*2 }} </span> </p>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                ...
                <li class="item"> <a href="shopping_cart.html" title="Sample Product" class="product-image"><img src="{{ asset('/items/' . $cartprolist['item']['imagePath']) }}" alt="Sample Product "></a>
          ...
          <div class="single-img-add sidebar-add-slider ">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <a href="#"><img src="{{asset('front/images/add-slide1.jpg')}}" alt="slide1"></a>
                ...
                <div class="item"> <a href="#"><img src="{{asset('front/images/add-slide2.jpg')}}" alt="slide2"></a>
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" Sample Product">Smartwatch Collection</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="info">All Collection</a> </div>
                </div>
                <div class="item"> <a href="#"><img src="{{asset('front/images/add-slide3.jpg')}}" alt="slide3"></a>
                  <div class="carousel-caption">
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              ...
              @foreach($topproduct as $top)
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="{{url('shop-details/'.$top->id.'/'.$top->subcategory_id)}}" title="Sample Product" class="product-image"><img src="{{asset('front/images/products/img02.jpg')}}" alt="Sample Product "></a></div>
