    ...
    <div class="container">
      <div class="row">
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <?php $proid = Session::get('proid') ?>
  @endif
              <div class="sorter">
                <div class="short-by">
                  <form action="{{route('subproduct',$proid)}}" method="POST">
                  <label>Sort By:</label>
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              ...
              @foreach($topproduct as $top)
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="{{url('shop-details/'.$top->id.'/'.$top->subcategory_id)}}" title="{{$top->title}}" class="product-image"><img src="{{asset('/items/' . $top->imagePath)}}" alt="Sample Product "></a></div>
