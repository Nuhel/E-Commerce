      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class=""> <a title="Go to Home Page" href="shop_grid.html"></a><span>&raquo;</span></li>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            ...
            <div class="product-grid-area">
              ...
              <!-- projuct loop start --> 
              @foreach($specialsave as $specialsave1) 
                <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                   
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="{{$specialsave1->title}}" href="{{url('shop-details/'.$specialsave1->id.'/'.$specialsave1->subcategory_id)}}">
                          <figure> <img class="first-img" src="{{asset('/items/' . $specialsave1->imagePath)}}" alt=""> <img class="hover-img" src="{{asset('/items/' . $specialsave1->imagePath)}}" alt=""></figure>
                          </a>
                           <a type="button" href="{{ route('product.addToCart', ['id' => $specialsave1->id]) }}" class="add-to-cart-mt" data-id="{{ $specialsave1->id }}">add to cart</a>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a  href="{{ route('product.addToWishlist',['id' => $specialsave1->id]) }}" class="addToWish" data-id="{{ $specialsave1->id }}"> <i class="fa fa-heart"></i> </a> </div>
                            <div class="mt-button add_to_compare"> <a href="{{url('compare/'.$specialsave1->id.'/'.$specialsave1->subcategory_id)}}"> <i class="fa fa-signal"></i> </a> </div>
                            <div class="mt-button quick-view"> <a href="{{url('quickview/'.$specialsave1->id.'/'.$specialsave1->subcategory_id)}}"> <i class="fa fa-search"></i> </a> </div>
                          </div>
                        </div>
                      </div>
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="{{ $specialsave1->title }}" href="{{url('shop-details/'.$specialsave1->id.'/'.$specialsave1->subcategory_id)}}">{{ $specialsave1->title }}</a> </div>
                          <div class="item-content">
                            <div class="rating">
                            <?php $pr=$specialsave1->review;
                                      if ($pr==0) {
                                         echo "not rated yet";
                                       }else{
                                        for($i=0; $i<5; $i++){ 
                            ...
                            <div class="item-price">
                              <div class="price-box">
                                <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> ${{ $specialsave1->price }} </span> </p>
                                <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"> ${{ $specialsave1->price*1.5 }} </span> </p>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
         ...
         @if(Session::has('cart'))
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              <p class="amount">There are <a href="{{ route('product.shoppingCart') }}">{{ Session::has('cart') ? Session::get('cart')->totalQty : '0' }} item</a> in your cart.</p>
              <ul>
                
                 @foreach($cartprolist as $cartprolist)  
                <li class="item"> <a href="{{ route('product.shoppingCart') }}" title="" class="product-image"><img src="{{ asset('/items/' . $cartprolist['item']['imagePath']) }}" alt=" "></a>
                  <div class="product-details">
                    <!-- <div class="access"> <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div> -->
                    <p class="product-name"> <a href="{{ route('product.shoppingCart') }}">{{ $cartprolist['item']['title'] }}</a> </p>
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <a href="{{route('saveupto')}}"><img src="{{asset('front/images/add-slide1.jpg')}}" alt="slide1"></a>
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" ">Sale Up to 50% off</a></h3>
                ...
                <div class="item"> <a href="{{url('blog')}}"><img src="{{asset('front/images/add-slide4.jpg')}}" alt="slide2"></a>
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" ">Smartwatch Collection</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                ...
                <div class="item"> <a href="{{url('requestproduct/create')}}"><img src="{{asset('front/images/add-slide3.jpg')}}" alt="slide3"></a>
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" ">Summer Sale</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  </div>
                </div>
              </div>
...
@if(Session::has('newarrival'))
  ...
  @foreach($special as $special) 
                <li class="item">
                  <div class="products-block-left"> <a href="{{url('shop-details/'.$special->id.'/'.$special->subcategory_id)}}" title="Product" class="product-image"><img src="{{asset('/items/' . $special->imagePath)}}" alt="{{$special->title}}"></a></div>
                  <div class="products-block-right">
                    <p class="product-name"> <a href="{{url('shop-details/'.$special->id.'/'.$special->subcategory_id)}}">{{$special->title}}</a> </p>
    ...
    @endforeach
              ...
              <a class="link-all" href="{{url('specialproduct')}}">All Products</a> </div>
          </div>
 @endif
 ...
 @if(Session::has('special'))
  ...
  @foreach($newproduct as $newproduct) 
                <li class="item">
                  <div class="products-block-left"> <a href="{{url('shop-details/'.$newproduct->id.'/'.$newproduct->subcategory_id)}}" title="Product" class="product-image"><img src="{{asset('/items/' . $newproduct->imagePath)}}" alt=" Product "></a></div>
                  <div class="products-block-right">
                    <p class="product-name"> <a href="{{url('shop-details/'.$newproduct->id.'/'.$newproduct->subcategory_id)}}">{{$newproduct->title}}</a> </p>
                    <span class="price">${{$newproduct->price}}</span>
                    <div class="rating">
                        <?php $pr=$newproduct->review;
                                      if ($pr==0) {
                                         echo "not rated yet";
                                       }else{
                                        for($i=0; $i<5; $i++){ 
    ...
    @endforeach
              ...
              <a class="link-all" href="{{url('specialsave', 'special' )}}">All Products</a> </div>
          </div>
 @endif
