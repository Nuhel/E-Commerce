                    ...
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Ipsums Dolors Untra" href="{{url('shop-details/'.$productshop->id.'/'.$productshop->subcategory_id)}}">{{ $productshop->title }}</a> </div>
                          <div class="item-content">
                            ...
                            <div class="item-price">
                              <div class="price-box">
                                ...
                                <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"> ${{ $productshop->price*1.2 }} </span> </p>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                ...
                <li class="item"> <a href="shopping_cart.html" title="Product" class="product-image"><img src="{{ asset('/items/' . $cartprolist['item']['imagePath']) }}" alt="Sample Product "></a>
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              ...
              @foreach($topproduct as $top)
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="{{url('shop-details/'.$top->id.'/'.$top->subcategory_id)}}" title="{{$top->title}}" class="product-image"><img src="{{asset('front/images/products/img02.jpg')}}" alt="{{$top->title}} "></a></div>
              ...
              <a class="link-all" href="{{route('specialproduct')}}">See More</a> </div>
          </div>
