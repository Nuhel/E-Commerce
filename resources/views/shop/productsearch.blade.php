      ...
      <div class="row">
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            ...
            <!--  <p class="alert alert-success result"> Search results for <b> </b></p> -->
             @if(Session::has('noitem'))     
        <div  class="alert alert-success"><p><i> {{ Session::get('noitem') }}</i></p></div>
  @endif
            </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="{{$details1->title}}" href="{{url('shop-details/'.$details1->id.'/'.$details1->subcategory_id)}}">
                          <figure> <img class="first-img" src="{{asset('/items/' . $details1->imagePath)}}" alt=""> <img class="hover-img" src="{{asset('/items/' . $details1->imagePath)}}" alt=""></figure>
                          </a>
                           <a type="button" href="{{ route('product.addToCart', ['id' => $details1->id]) }}" class="add-to-cart-mt" data-id="{{ $details1->id }}">add to cart</a>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"> @if(Auth::check()) <a  href="{{ route('product.addToWishlist',['id' => $details1->id]) }}" class="addToWish" data-id="{{ $details1->id }}"> <i class="fa fa-heart"></i> </a>@else
                                    <a  href="{{ route('user.signin') }}" title="Please Sign in First!"> <i class="fa fa-heart"></i> </a>@endif
                                   </div>

                            <div class="mt-button add_to_compare"> <a href="{{url('compare/'.$details1->id.'/'.$details1->subcategory_id)}}"> <i class="fa fa-signal"></i> </a> </div>
                            <div class="mt-button quick-view"> <a href="{{url('quickview/'.$details1->id.'/'.$details1->subcategory_id)}}"> <i class="fa fa-search"></i> </a> </div>
                          </div>
                        </div>
                      </div>
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="{{ $details1->title }}" href="{{url('shop-details/'.$details1->id.'/'.$details1->subcategory_id)}}">{{ $details1->title }}</a> </div>
                          <div class="item-content">
                            <div class="rating">
                            <?php $pr=$details1->review;
                                      if ($pr==0) {
                                         echo "not rated yet";
                                       }else{
                                        for($i=0; $i<5; $i++){ 
                            ...
                            <div class="item-price">
                              <div class="price-box">
                                <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> ${{ $details1->price }} </span> </p>
                                <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"> ${{ $details1->price*1.5 }} </span> </p>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                ...
                <li class="item"> <a href="" title="Product" class="product-image"><img src="{{ asset('/items/' . $cartprolist['item']['imagePath']) }}" alt="Sample Product "></a>
                  <div class="product-details">
                    <!-- <div class="access"> <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div> -->
                    <p class="product-name"> <a href="">{{ $cartprolist['item']['title'] }}</a> </p>
